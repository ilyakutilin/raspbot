...
NO_TODAY_DEPARTURES = (
    ...
    f'"{clean_text(btn.TOMORROW)}" под этим сообщением.'
)
...
DOES_NOT_LOOK_LIKE_A_DATE = (
    "Ваше сообщение не похоже на дату. Пожалуйста, введите дату в одном из "
...
_PRESS_RECENT_OR_ADD_ALL = (
    ...
    f'"{clean_text(btn.ADD_ALL_RECENT_TO_FAV)}".\n\n'
...
FAV_LIST_WITH_RECENTS_TO_BE_FAVED = (
    ...
    f'"{clean_text(btn.ADD_MORE_TO_FAV)}", чтобы вывести их и добвавить в избранное '
    "при необходимости."
)
