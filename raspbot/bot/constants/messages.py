...
FAV_DELETED_MORE_REMAINING = (
    "Маршрут {route} удален из избранного 🗑\n\n"
    "Ниже перечислены маршруты, оставшиеся в избранном. "
    "Нажмите на нужный маршрут, чтобы удалить его 🗑"
)
FAV_DELETED_NOW_EMPTY = (
    "Маршрут {route} удален из избранного 🗑\n\n" "Больше маршрутов в избранном нет 🤷‍♂️"
)
